...
public class typehuile extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        map.put("titre", "Huile pour visage");
        ...
        map = new HashMap<>();
        map.put("titre", "Huile pour corps");
        ...
        maListViewPerso.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                {
                    case 0:
                        Intent newActivity = new Intent(typehuile.this,huilevisage.class);
                        startActivity(newActivity);
                        break;
                    case 1:
                        Intent newActivity1 = new Intent(typehuile.this,huilecorps.class);
