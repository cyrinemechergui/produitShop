...
public class mascara extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mascara);      // Récupération de la "ListView" créée dans le fichier activity_main.xml
        ...
        map = new HashMap<>();
        map.put("titre", "xtremecara");

        map.put("img", String.valueOf(R.drawable.m2));
        listItem.add(map);

        map = new HashMap<>();
        map.put("titre", "essence");

        map.put("img", String.valueOf(R.drawable.m3));
        listItem.add(map);
        ...
        maListViewPerso.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                {
                    case 0:
                        Intent newActivity = new Intent(mascara.this,confirme_mascara1.class);
                        startActivity(newActivity);
                        break;
                    case 1:
                        Intent newActivity1 = new Intent(mascara.this,confirme_mascara2.class);
                        startActivity(newActivity1);
                        break;
                    case 2:
                        Intent newActivity2 = new Intent(mascara.this,confirme_mascara3.class);
