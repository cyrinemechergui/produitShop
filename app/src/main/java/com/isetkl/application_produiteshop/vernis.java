...
public class vernis extends AppCompatActivity {
    protected ListView maListViewPerso;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_vernis);
        ...
        map = new HashMap<>();
        map.put("titre", "vernis fortifian");

        map.put("img", String.valueOf(R.drawable.v2));
        listItem.add(map);

        map = new HashMap<>();
        map.put("titre", "perfect gel");

        map.put("img", String.valueOf(R.drawable.v3));
        listItem.add(map);

        map = new HashMap<>();
        map.put("titre", "vernis ongles hermes");

        map.put("img", String.valueOf(R.drawable.v4));
        listItem.add(map);
        ...
        maListViewPerso.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                {
                    case 0:
                        Intent newActivity = new Intent(vernis.this,confirme_vernis1.class);
                        startActivity(newActivity);
                        break;
                    case 1:
                        Intent newActivity1 = new Intent(vernis.this,confirme_vernis2.class);
                        startActivity(newActivity1);
                        break;
                    case 2:
                        Intent newActivity2 = new Intent(vernis.this,confirme_vernis3.class);
                        startActivity(newActivity2);
                        break;
                    case 3:
                        Intent newActivity3 = new Intent(vernis.this,confirme_vernis4.class);
