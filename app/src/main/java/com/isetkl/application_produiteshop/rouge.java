...
public class rouge extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        map = new HashMap<>();
        map.put("titre", "rouge edution velvet");

        map.put("img", String.valueOf(R.drawable.r2));
        listItem.add(map);

        map = new HashMap<>();
        map.put("titre", "supper mat pro");

        map.put("img", String.valueOf(R.drawable.r3));
        listItem.add(map);

        map = new HashMap<>();
        map.put("titre", "eau a levre");

        map.put("img", String.valueOf(R.drawable.r4));
        listItem.add(map);
        ...
        maListViewPerso.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                {
                    case 0:
                        Intent newActivity = new Intent(rouge.this,confirme_rouge1.class);
                        startActivity(newActivity);
                        break;
                    case 1:
                        Intent newActivity1 = new Intent(rouge.this,confirme_rouge2.class);
                        startActivity(newActivity1);
                        break;
                    case 2:
                        Intent newActivity2 = new Intent(rouge.this,confirme_rouge3.class);
                        startActivity(newActivity2);
                        break;
                    case 3:
                        Intent newActivity3 = new Intent(rouge.this,confirme_rouge4.class);
