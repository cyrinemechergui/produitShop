...
public class ongle extends AppCompatActivity {
    protected ListView maListViewPerso;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_ongle);
        ...
        map = new HashMap<>();
        map.put("titre", "mycos du ongle");

        map.put("img", String.valueOf(R.drawable.pa2));
        listItem.add(map);

        map = new HashMap<>();
        map.put("titre", "huile ongle");

        map.put("img", String.valueOf(R.drawable.pa3));
        listItem.add(map);

        map = new HashMap<>();
        map.put("titre", "la redoute");

        map.put("img", String.valueOf(R.drawable.pa4));
        listItem.add(map);
        ...
        maListViewPerso.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                {
                    case 0:
                        Intent newActivity = new Intent(ongle.this,confirme_pongle1.class);
                        startActivity(newActivity);
                        break;
                    case 1:
                        Intent newActivity1 = new Intent(ongle.this,confirme_pongle2.class);
                        startActivity(newActivity1);
                        break;
                    case 2:
                        Intent newActivity2 = new Intent(ongle.this,confirme_pongle3.class);
                        startActivity(newActivity2);
                        break;
                    case 3:
                        Intent newActivity3 = new Intent(ongle.this,confirme_pongle4.class);
